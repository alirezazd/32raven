...
class ServingState : public IState<StateMachineContext> {
 public:
...
class MavlinkWifiState : public IState<StateMachineContext> {
 public:
...
class MavlinkUsbState : public IState<StateMachineContext> {
 public:
...
class ServiceState : public IState<StateMachineContext> {
 public:
...
class ProgramState : public IState<StateMachineContext> {
 public:
...
class EscConfigState : public IState<StateMachineContext> {
 public:
...
class WifiLogState : public IState<StateMachineContext> {
 public:
...
class LogPullState : public IState<StateMachineContext> {
 public:
 ...
 private:
  ...
  void SendRequest(StateMachineContext &ctx);
  void Finish(StateMachineContext &ctx, const char *ctrl_line);
