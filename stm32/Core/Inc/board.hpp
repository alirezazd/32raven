...
// User I/O — kUserLed and kUserBtn are now Kconfig-tunable and emitted into
// the autogenerated stm32_config.hpp by scripts/generate_stm32_config.py.
// See `STM32 -> Pin Map -> User I/O -> LED / Button` in menuconfig.
...
inline const BoardPin kSpi2Sck = {GPIOB, GPIO_PIN_13, GPIO_AF5_SPI2,
                                  NonMaskableInt_IRQn};
inline const BoardPin kSpi2MisoMosi = {GPIOB, GPIO_PIN_14 | GPIO_PIN_15,
                                       GPIO_AF5_SPI2, NonMaskableInt_IRQn};
inline const BoardPin kSpi2Cs = {GPIOA, GPIO_PIN_4, 0, NonMaskableInt_IRQn};

// EEPROM / external flash on SPI1.
inline const BoardPin kSpi1Sck = {GPIOB, GPIO_PIN_3, GPIO_AF5_SPI1,
                                  NonMaskableInt_IRQn};
inline const BoardPin kSpi1MisoMosi = {GPIOB, GPIO_PIN_4 | GPIO_PIN_5,
                                       GPIO_AF5_SPI1, NonMaskableInt_IRQn};
