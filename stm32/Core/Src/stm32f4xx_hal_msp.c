...
void HAL_UART_MspInit(UART_HandleTypeDef *huart) {
  ...
  if(huart->Instance==USART6)
  {
    ...
    */
    ...
    // UART2 GPIO pins (TX/RX) are configured by GPIO::Init from kGpioDefault,
    // which consumes board::kUart2Tx / board::kUart2Rx (Kconfig-tunable).
    // Only the USART peripheral clock and DMA stay here.
