...
def _runtime_context(source: pathlib.Path, kconf: kconfiglib.Kconfig) -> dict[str, object]:
    return {
        ...
        "display_i2c": {
            ...
            "xfer_timeout_ms": _sym_int(
                kconf, "ESP32_DISPLAY_PANEL_I2C_TIMEOUT_MS"
            ),
        ...
        "display_panel": {
            ...
            "i2c_scl_speed_hz": _sym_int(
                kconf, "ESP32_DISPLAY_PANEL_I2C_CLOCK_HZ"
            ),
            "i2c_scl_wait_us": _sym_int(
        ...
        "tcp_server": {
            ...
            "keepalive_idle_s": _sym_int(
                kconf, "ESP32_TCP_SERVER_KEEPALIVE_IDLE_S"
            ),
        ...
        "wifi": {
            "ap": {
                ...
                "max_connections": _sym_int(
                    kconf, "ESP32_WIFI_AP_MAX_CONNECTIONS"
                ),
